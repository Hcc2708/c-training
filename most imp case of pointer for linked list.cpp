...
int main()
{
 ...
 p=d;  /// after doing expression with p the value of a will not affect.... in this case its not like a=d
 (*p)++;  /// but here it is like (*d)++ by this also the value of *p will be 4
 cout<<*p<<*a;
}
